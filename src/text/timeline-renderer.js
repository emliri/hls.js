...
import Cea608Parser from './cea-608-parser';
import OutputFilter from './output-filter';
import WebVTTParser from './webvtt-parser';

import { logger } from '../utils/logger';
import { sendAddTrackEvent, clearCurrentCues } from './texttrack-utils';
...
export class TimelineRenderer extends EventHandler {
  constructor (hls) {
