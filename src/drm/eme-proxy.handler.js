 ...
 * @constructor
 */
export class EMEProxyHandler extends EventHandler {
  /**
     * @constructs
  ...
  getLicenseServerUrl (keySystem) {
    ...
    if (!url) {
      ...
      this.hls.trigger(Event.ERROR, {
        ...
        details: ErrorDetail.KEY_SYSTEM_LICENSE_REQUEST_FAILED,
        fatal: true
      });
    }
  ...
  _attemptSetMediaKeys () {
    if (!this._hasSetMediaKeys) {
      ...
      if (!keysListItem || !keysListItem.mediaKeys) {
        ...
        this.hls.trigger(Event.ERROR, {
          type: ErrorType.KEY_SYSTEM_ERROR,
          details: ErrorDetail.KEY_SYSTEM_NO_KEYS,
          fatal: true
        });
        return;
      }
  ...
  _generateRequestWithPreferredKeySession () {
    ...
    if (!keysListItem) {
      ...
      this.hls.trigger(Event.ERROR, {
        type: ErrorType.KEY_SYSTEM_ERROR,
        details: ErrorDetail.KEY_SYSTEM_NO_ACCESS,
        fatal: true
      });
      return;
    }
    ...
    if (!keySession) {
      ...
      this.hls.trigger(Event.ERROR, {
        type: ErrorType.KEY_SYSTEM_ERROR,
        details: ErrorDetail.KEY_SYSTEM_NO_SESSION,
        fatal: true
      });
    }
